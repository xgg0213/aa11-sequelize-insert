const build = async () => {
  ...
  try {
    ...
    // microchipped: false
    // Your code here 
    const newPuppy = Puppy.build({name: "Trudy", ageYrs: 2, weightLbs: 38, 
    breed: "Brittany Spaniel", microchiipped: false})
...
const create = async () => {
  ...
  try {
    ...
    // microchipped: true
    // Your code here 
    const newPuppy = await Puppy.create({name: "Beans", ageYrs: 1.6, weightLbs: 42, 
    breed: "Bulldog", microchipped: true})
